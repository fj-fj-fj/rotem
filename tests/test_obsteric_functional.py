"""Test "interpretation-of-thi-result" functional (obsteric category)."""
import re
...
"description": "При коровотечении акцент на хирургический гемостаз"}',
        ...
        # Test "case 2" (FIBRINOGEN_DEFICIENCY).
        (
            ImmutableMultiDict(
                [
                    ("data_extem_a5", "34"),
...
"description": "Криопреципитат до достижения FIBTEM A5 16 мм (см. расчет дозы)"}',
        ...
        # Test "case 3" (SIGNIFICIANT_THROMBOCYTOPENIA).
        (
            ImmutableMultiDict(
                [
                    ("data_extem_a5", "34"),
...
"description": "Тромбоцитарная масса 1 доза / 10 кг или\\nТромбоконцентрат 1-2 дозы"}',
        ...
        # Test "case 4" (FIBRINOGEN_DEFICIENCY_AND_SIGNIFICIANT_THROMBOCYTOPENIA).
        (
            ImmutableMultiDict(
                [
                    ("data_extem_a5", "24"),
...
"description": "Криопреципитат до достижения FIBTEM A5 16 мм (см. расчет дозы)\\n1-2 тромбоцитарной массы"}',
        ...
        # Test "case 5" (DEFICIENCY_OF_FACTORS_EXTERNALLY).
        (
            ImmutableMultiDict(
                [
                    ("data_extem_ct", "80"),
...
CT EXTEM >120 сек – 22,5 МЕ/кг"}',
        ...
        # Test "case 6" (FIBRINOGEN_DEFICIENCY_POSSIBLE_AND_DEFICIENCY_OF_EXTRINSIC_PATHWAY_FACTORS).
        (
            ImmutableMultiDict(
                [
                    ("data_extem_ct", "80"),
...
"description": "Криопреципитат до достижения FIBTEM A5 16 мм,\\nповторная оценка EXTEM и FIBTEM"}',
        ...
        # Test "case 7 subcase 1 int(value)" (HEPARIN_EFFECT).
        (
            ImmutableMultiDict(
                [
                    ("data_intem_ct", "240"),
...
"description": "Протамин 0,5 мг/кг"}',
        ...
        # Test "case 7 subcase 2 float(value)" (HEPARIN_EFFECT).
        (
            ImmutableMultiDict(
                [
                    ("data_intem_ct", "0.7"),
...
"description": "Протамин 0,5 мг/кг"}',
        ...
        # Test "case 8" (DEFICIENCY_OF_FACTORS_INTERNALLY).
        (
            ImmutableMultiDict(
                [
                    ("data_intem_ct", "240"),
...
def test__ResulFetcher_with_obsteric_category(request_form, expected):
    """Show 'interpretation-of-the-result' or error."""
    # Set into session clicked-category-test (ajax data)
    with client.session_transaction() as session:
        session["clicked_category_button"] = "obsteric_category"
